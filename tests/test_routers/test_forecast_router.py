...
class TestForecastRouter:
    ...
    def test_sequential_requires_auth_when_api_key_set(
        self, client, sequential_payload, monkeypatch, fake_model_store
    ):
    ...
    def test_mixed_regions_returns_422(
        self, client, sequential_payload, fake_model_store
    ):
